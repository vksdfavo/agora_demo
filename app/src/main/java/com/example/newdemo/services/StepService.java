...
import com.example.newdemo.AudioCallActivity;
import com.example.newdemo.ConstantsStep;
import com.example.newdemo.R;
import com.example.newdemo.Steps;
...
public class StepService extends Service implements SensorEventListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (action) {
            ...
            case ConstantsStep.START_FOREGROUND:
                Log.d(TAG, "starting service");
                break;

            case ConstantsStep.RESET_COUNT:
                resetCount();
                break;

            case ConstantsStep.STOP_SAVE_COUNT:
                stopForegroundService(true);

            case ConstantsStep.STOP_FOREGROUND:
    ...
    public HashMap<String, String> getData() {
        ...
        data.put("steps", String.format(String.valueOf(lastSteps + stepCount)));
        data.put("distance", String.format(distanceString));
        data.put("orientation", String.format(String.valueOf(compassOrientation)));
        data.put("duration", String.format(String.valueOf(timeString)));
    ...
    private Notification getNotification(String title, String body) {
        ...
        PendingIntent resultPendingIntent = PendingIntent.getActivity(this, 9, intent, PendingIntent.FLAG_IMMUTABLE);
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                .setSmallIcon(R.drawable.baseline_call_24)
                .setContentTitle(title)
                .setContentText(body)
                .setLargeIcon(Bitmap.createScaledBitmap(BitmapFactory.decodeResource(this.getResources(), R.drawable.baseline_call_24), 97, 128, false))
